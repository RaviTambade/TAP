...
CREATE TABLE customers(cust_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
...
CREATE TABLE addresses(address_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE orderdetails( orderdetails_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
